...
/***/ function(module, exports, __webpack_require__) {
	...
	var pillarItem = function pillarItem(state, action) {
	  switch (action.type) {
	...
	var pillarsItems = function pillarsItems() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case 'ADD_PILLAR_ITEM':
	      return [].concat(_toConsumableArray(state), [pillarItem(undefined, action)]);
	    default:
	      return state;
	  }
	};

	var pillarsApp = (0, _redux.combineReducers)({
	  pillarsItems: pillarsItems
	});

	var PillarItem = function PillarItem(_ref) {
	...
	var PillarsTable = function PillarsTable(_ref2) {
	  var pillarsItems = _ref2.pillarsItems;
	  return _react2.default.createElement(
	    'table',
	    null,
	    _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'tbody',
	      null,
	      pillarsItems.map(function (pillarItem) {
	        return _react2.default.createElement(PillarItem, _extends({
	          key: pillarItem.id
	        }, pillarItem));
	      })
	    )
	...
	var store = (0, _redux.createStore)(pillarsApp);
	var nextPillarItemId = 0;

	var PillarsApp = function (_React$Component) {
	  _inherits(PillarsApp, _React$Component);

	  function PillarsApp() {
	    _classCallCheck(this, PillarsApp);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PillarsApp).apply(this, arguments));
	  }

	  _createClass(PillarsApp, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;

	      var pillarsItems = this.props.pillarsItems;
	        ...
	        _react2.default.createElement(
	          ...
	          { onClick: function onClick() {
	              store.dispatch({
	                ...
	                duration: '00:30:00',
	                quality: 'YAY',
	                notes: _this2.input.value
	              });
	              _this2.input.value = '';
	            } },
	          'Add Pillar'
	        ),
	        _react2.default.createElement(PillarsTable, {
	          pillarsItems: pillarsItems
	        })
	      );
	    }
	...
	var render = function render() {
	  _reactDom2.default.render(_react2.default.createElement(PillarsApp, store.getState()), document.getElementById('root'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(37);
